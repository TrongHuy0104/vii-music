...
// 		} else {
// 			navigateToArtistProfile(activeTrack.artists[0].id)
// 		}
// 	}
// 	const navigateToArtistProfile = (artistId) => {
// 		// Replace with navigation logic to ArtistProfile.jsx
...
// 								<Text style={[styles.trackArtistText, { marginTop: 6 }]}>{displayArtistNames}</Text>
// 							</TouchableOpacity>

// 							{/* Modal for multiple artists */}
...
// 											key={artist.id}
// 											onPress={() => {
// 												navigateToArtistProfile(artist.id)
